...
<footer id="colophon" class="site-footer">
    ...
    <div class="footer-contact">
        ...
        <p>Address: <a
                ...
                Arts, Seeley Drive, London, SE21 8QN</a></p>

    </div>
    <div class="footer-socials">
        <!-- Social Media Links -->
        <ul>
            <li><a target="_blank" href="https://www.facebook.com/hartshornhook1"><img
                        src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/facebook.svg"
                        alt="Facebook"></a></li>
            <li><a target="_blank" href="https://x.com/hartshornhook"><img
                        src="<?php echo get_template_directory_uri(); ?>/assets/img/icons/twitter.svg"
                        alt="Twitter"></a></li>
            <li><a target="_blank" href="https://www.instagram.com/hartshornhook/"><img
