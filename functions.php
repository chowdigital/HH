...
function cloudsdale_master_scripts() {
	...
	wp_enqueue_style( 'cloudsdale-master-style', get_stylesheet_uri(), array(), $ver = 2.5 );
	...
	wp_enqueue_script( 'custom', get_template_directory_uri() . '/js/custom.js', array(), $ver = 1.7, true );
